...
/**
 * ===============================================
 * GameConfig Context  Zustand-backed
 * ===============================================
 * No React context. State comes from useGameTypeStore.
 * GameConfigProvider is kept as a no-op passthrough for
 * backward-compatibility with existing provider trees.
 */
...
// ---------------------------------------------------------------------------
// Provider  no-op passthrough (kept for provider-tree compatibility)
// ---------------------------------------------------------------------------
export function GameConfigProvider({ children }: GameConfigProviderProps) {
  return <>{children}</>;
}

// ---------------------------------------------------------------------------
// Core logic  builds config value from a game type
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Core hook  reads gameType from the Zustand store
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Specialised hooks (unchanged API)
// ---------------------------------------------------------------------------
