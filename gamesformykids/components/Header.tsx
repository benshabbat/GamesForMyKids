  ...
  return (
    <header className="text-center py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-16 right-16 text-5xl opacity-20 animate-pulse">🎈</div>
        <div className="absolute bottom-10 left-20 text-4xl opacity-20 animate-bounce" style={{animationDelay: '1s'}}>🎨</div>
        <div className="absolute bottom-16 right-12 text-5xl opacity-20 animate-pulse" style={{animationDelay: '2s'}}>📚</div>
      </div>
