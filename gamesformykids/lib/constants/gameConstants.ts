...
export const EMOTION_HEBREW_PRONUNCIATIONS: Record<string, string> = {
  happy: "שמח",
  sad: "עצוב", 
  angry: "כועס",
  surprised: "מופתע",
...
// רשימות הפריטים למשחקים
export const ALL_EMOTIONS: BaseGameItem[] = createItemsList(EMOTION_CONSTANTS);
