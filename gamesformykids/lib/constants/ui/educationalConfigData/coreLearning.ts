...
export const coreLearningConfigs: Partial<Record<string, GameUIConfig>> = {
  ...
  letters: {
    ...
    metadata: {
      keywords: "משחק אותיות לילדים, אלפבית עברי, לימוד אותיות, אותיות סופיות, גיל 4-8, עברית, א ב ג",
      description: "משחק אינטראקטיבי ללימוד כל 27 אותיות האלפבית העברי לילדים בגיל 4-8, כולל אותיות סופיות. שמעו את שם האות ובחרו נכון!",
    },
  },
