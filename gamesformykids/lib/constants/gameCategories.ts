...
export const GAME_CATEGORIES: Record<string, GameCategory> = {
  ...
  home: {
    ...
    gameIds: ["house","clothing","professions","tools","tzedakah","kitchen","family","body-parts","new-professions","morning-routine","dress-up"],
  },
  math: {
  ...
  arcade: {
    ...
    gameIds: [
      ...
      "reflex","taki","checkers","chess","shesh-besh","maze","letter-defender","snakes-ladders","escape-room","find-in-scene","answer-cannon","word-fishing","letter-grow","letter-slingshot","syllable-drums",
    ],
  },
  educational: {
