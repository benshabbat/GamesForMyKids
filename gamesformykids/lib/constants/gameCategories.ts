...
export const GAME_CATEGORIES: Record<string, GameCategory> = {
  ...
  arcade: {
    ...
    gameIds: [
      ...
      "reflex","taki","checkers","chess","shesh-besh","maze","letter-defender","snakes-ladders","escape-room","find-in-scene","answer-cannon","word-fishing","letter-grow","letter-slingshot",
    ],
  },
  educational: {
