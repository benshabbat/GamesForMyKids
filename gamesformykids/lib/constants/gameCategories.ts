...
export const GAME_CATEGORIES: Record<string, GameCategory> = {
  basic: {
    ...
    gameIds: ["letters","hebrew-letters","letter-trace","numbers","shapes","colored-shapes","colors","advanced-colors","shapes-3d","phonics","rhyming","nikud","gender","final-letters","alphabet-order","letter-race","nikud-drag","letter-merge","word-clicker"],
  },
  creative: {
  ...
  math: {
    ...
    gameIds: ["counting","math","shopping-money","coins-match","multiplication","fractions","sequences","arithmetic","ordinals","number-words","spatial-concepts","sorting","patterns","skip-counting","division","visual-addition","gematria","number-slide","math-stories","number-merge","mispar-bonds","sudoku"],
  },
  games: {
  ...
  arcade: {
    ...
    gameIds: [
      ...
      "reflex","taki","checkers","chess","shesh-besh","maze","letter-defender","snakes-ladders","escape-room","find-in-scene","answer-cannon","word-fishing","letter-grow","letter-slingshot","syllable-drums","letter-bubble-shooter","letter-slicer","spot-the-difference","candy-match",
    ],
  },
  educational: {
