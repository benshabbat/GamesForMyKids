 ...
 * ===============================================
 *
 * כל פונקציה מסנתזת צליל טבע אמיתי ללא TTS.
 * נקרא על ידי useNatureSoundsGame כשהמשחק צריך
 * להשמיע רמז קולי לשחקן (במקום קול אדם).
 */
...
const SYNTH_MAP: Record<string, (ctx: AudioContext) => Promise<void>> = {
