...
export const gamesRegistryBatch3: GameRegistration[] = [
  ...
  { id: "true-false",       title: "נכון או לא נכון",               description: "ענה נכון/לא נכון על עובדות מעניינות!",             icon: Lightbulb,      emoji: "✅", color: "bg-teal-500 hover:bg-teal-600",                                                                         href: "/games/true-false",      available: true, order: 111, contentType: 'riddle' as const },
  ...
  { id: "word-scramble",    title: "מילים מבולבלות",                 description: "סדר את האותיות ליצירת המילה הנכונה!",              icon: BookOpen,       emoji: "🔡", color: "bg-green-500 hover:bg-green-600",                                                                       href: "/games/word-scramble",   available: true, order: 115, contentType: 'riddle' as const },
];
