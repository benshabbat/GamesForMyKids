...
export const gamesRegistryBatch1: GameRegistration[] = [
  ...
  { id: "puzzles",         title: "משחק פאזלים",                    description: "הרכב תמונות יפות!",                                       icon: Puzzle,         emoji: "🧩", color: "bg-purple-400 hover:bg-purple-500",                                                                         href: "/games/puzzles",         available: true, order: 23, contentType: 'creative' as const },
  { id: "drawing",         title: "משחק ציורים",                    description: "צייר יצירות אמנות!",                                      icon: Paintbrush,     emoji: "✏️", color: "bg-orange-400 hover:bg-orange-500",                                                                         href: "/games/drawing",         available: true, order: 24, contentType: 'creative' as const },
  { id: "coloring",        title: "צביעת תמונות",                   description: "בחר צבע וצבע ציורים מהנים!",                              icon: Palette,        emoji: "🎨", color: "bg-gradient-to-r from-pink-400 to-purple-400 hover:from-pink-500 hover:to-purple-500",               href: "/games/coloring",        available: true, order: 24.5, contentType: 'creative' as const },
  { id: "building",        title: "סטודיו הבנייה הקסום",            description: "בנה יצירות עם צורות צבעוניות!",                          icon: Building,       emoji: "🏗️", color: "bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600",              href: "/games/building",        available: true, order: 25, contentType: 'creative' as const },
