...
export const gamesRegistryBatch2: GameRegistration[] = [
  ...
  { id: "geography-capitals",   title: "בירות העולם",   description: "מה הבירה של כל מדינה?",         icon: Earth, emoji: "🏛️", color: "bg-teal-700 hover:bg-teal-800", href: "/games/geography-capitals",   available: true, order: 96 },
  { id: "geography-continents", title: "יבשות העולם",   description: "באיזו יבשת נמצאת המדינה?",     icon: Earth, emoji: "🌍", color: "bg-cyan-600 hover:bg-cyan-700",  href: "/games/geography-continents", available: true, order: 97 },
