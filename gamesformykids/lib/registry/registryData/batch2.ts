...
export const gamesRegistryBatch2: GameRegistration[] = [
  ...
  { id: "art-craft",        title: "אמנות ויצירה",                   description: "הכר כלי אמנות וצור יצירות מדהימות!",                   icon: Paintbrush,     emoji: "🖌️", color: "bg-rose-500 hover:bg-rose-600",                                                                         href: "/games/art-craft",       available: true, order: 61, contentType: 'creative' as const },
  ...
  { id: "trivia",           title: "ידע כללי",                      description: "שאלות על טבע, מדע, חלל ועוד!",                        icon: Brain,          emoji: "🎯", color: "bg-amber-500 hover:bg-amber-600",                                                                       href: "/games/trivia",          available: true, order: 72, contentType: 'riddle' as const },
  { id: "color-mix",        title: "ערבוב צבעים",                   description: "מה מקבלים כשמערבבים צבעים?",                          icon: Paintbrush,     emoji: "🎨", color: "bg-pink-500 hover:bg-pink-600",                                                                         href: "/games/color-mix",       available: true, order: 73, contentType: 'creative' as const },
  ...
  { id: "opposites",        title: "ניגודים",                       description: "גדול-קטן, חם-קר ועוד הפכים!",                         icon: ArrowLeftRight, emoji: "↔️", color: "bg-orange-500 hover:bg-orange-600",                                                                     href: "/games/opposites",       available: true, order: 78, contentType: 'riddle' as const },
  ...
  { id: "riddles",          title: "חידות לילדים",                  description: "פתור חידות מסקרנות ומהנות!",                          icon: Lightbulb,      emoji: "💡", color: "bg-purple-600 hover:bg-purple-700",                                                                     href: "/games/riddles",         available: true, order: 80, contentType: 'riddle' as const },
