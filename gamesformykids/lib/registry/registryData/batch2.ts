...
export const gamesRegistryBatch2: GameRegistration[] = [
  ...
  { id: "singular-plural", title: "יחיד ורבים",                    description: "למד צורות רבים בעברית!",                             icon: Brain,          emoji: "📝", color: "bg-teal-500 hover:bg-teal-600",                                                                         href: "/games/singular-plural", available: true, order: 138 },
  { id: "morning-routine", title: "שגרת הבוקר",                    description: "מה בא אחרי מה בשגרת היום?",                          icon: Clock,          emoji: "🌅", color: "bg-amber-500 hover:bg-amber-600",                                                                       href: "/games/morning-routine", available: true, order: 139 },
];
