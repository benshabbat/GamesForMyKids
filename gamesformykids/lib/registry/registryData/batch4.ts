...
export const gamesRegistryBatch4: GameRegistration[] = [
  ...
  { id: "days-of-week",    title: "ימות השבוע",                    description: "למד את ימות השבוע בעברית!",                      icon: Star,           emoji: "📅", color: "bg-blue-400 hover:bg-blue-500",                                                                         href: "/games/days-of-week",    available: true, order: 135 },
  { id: "months-of-year",  title: "חודשי השנה",                    description: "למד את חודשי השנה בעברית!",                      icon: Star,           emoji: "🗓️", color: "bg-purple-400 hover:bg-purple-500",                                                                     href: "/games/months-of-year",  available: true, order: 136 },
];
