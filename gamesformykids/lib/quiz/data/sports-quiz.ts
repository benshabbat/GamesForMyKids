...
export const SPORTS_QUESTIONS: SportsQuestion[] = [
  ...
  { id: 3,  sport: 'שחייה',    emoji: '🏊', question: 'איך קוראים לסגנון השחייה שבו שתי הידיים עולות יחד קדימה?', answers: ['חזה', 'גב', 'פרפר', 'חתירה'],    correctIndex: 2 },
  ...
  { id: 15, sport: 'הרמת משקולות', emoji: '🏋️', question: 'בענף "הרמת משקולות" — מה מרימים?',        answers: ['מוט ברזל עם משקולות', 'אבנים', 'כדור', 'שק חול'], correctIndex: 0 },
