...
export const LANGUAGE_QUESTIONS: LanguageQuestion[] = [
  ...
  { id: 6,  country: 'סין 🇨🇳',        flag: '🇨🇳', language: 'סינית',     wrongOptions: ['יפנית', 'קוריאנית', 'מונגולית'] },
  ...
  { id: 11, country: 'יוון 🇬🇷',       flag: '🇬🇷', language: 'יוונית',    wrongOptions: ['לטינית', 'איטלקית', 'ספרדית'] },
  { id: 12, country: 'אוקראינה 🇺🇦',   flag: '🇺🇦', language: 'אוקראינית', wrongOptions: ['רוסית', 'פולנית', 'בלרוסית'] },
