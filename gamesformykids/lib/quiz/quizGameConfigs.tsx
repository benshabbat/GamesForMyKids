...
import { fractionsConfig, gematriaConfig, mathStoriesConfig, misparBondsConfig, shapes3dConfig, skipCountingConfig, visualAdditionConfig } from './configs/math';
...
export const QUIZ_GAME_CONFIGS: Partial<Record<GameType, QuizGameConfig<unknown>>> = {
  ...
  'mispar-bonds': misparBondsConfig,
};
