...
import { PALETTE_COLORS } from '../store/coloringStore';
import { useColoringPalette } from '../useColoringPalette';

export function ColoringPalette() {
  const { selectedColor, selectColor, selectedColorName } = useColoringPalette();
