...
export default function ChallengeBox({ onSpeak }: ChallengeBoxProps) {
  return (
    <div className="bg-white rounded-3xl p-8 mb-8 shadow-xl">
      ...
      <div
        className="text-6xl md:text-8xl font-bold mb-4 text-green-800 cursor-pointer hover:scale-110 transition-transform"
        onClick={onSpeak}
      >
        🔷
      ...
      <p className="text-xl text-gray-600">בחר את הצורה הנכונה!</p>
    </div>
  );
}