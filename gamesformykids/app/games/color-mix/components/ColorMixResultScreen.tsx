...
export default function ColorMixResultScreen({ score, total, onRestart, onMenu }: Props) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 p-4 flex items-center" dir="rtl">
      <div className="max-w-md mx-auto w-full bg-white rounded-3xl shadow-xl p-8 text-center">
        ...
        <div className="flex gap-3">
          <button onClick={onRestart} className="flex-1 py-4 rounded-2xl text-white font-bold bg-gradient-to-l from-pink-500 to-purple-500 hover:opacity-90 active:scale-95 transition-all">🔄 שוב</button>
