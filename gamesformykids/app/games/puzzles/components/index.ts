...
export { default as HelpTipsSection } from './HelpTipsSection';
export { default as HelpControlsSection } from './HelpControlsSection';
export { default as HelpKeyboardSection } from './HelpKeyboardSection';
...
export { default as UploadDifficultySelector } from './UploadDifficultySelector';
